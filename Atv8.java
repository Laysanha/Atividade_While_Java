...
//Considere que cada aluno fez três provas, por isso para cada aluno deverá ser digitado também, alem
//de seu nome, as suas três notas.
...
public class Atv8 {
	public static void main (String [] args) {
		...
		while (confirma == 'S') {
			...
			JOptionPane.showMessageDialog(null, "Tabela de notas \n Aluno(a):" + nome 
						+ "\n" + "Notas:" + nota1 + "\n" + nota2 + "\n" + nota3);
